%rebase('main_template', title='Web Translator - Main page')
...
<ul>
    <li><a href="https://github.com">Sign-up at github.com</a></li>
    <li><a href="https://github.com/OpenTTD/team/issues/new/choose">Request access to a language</a></li>
</ul>
